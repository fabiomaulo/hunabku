...
namespace EnverIntroduction
{
	public class NHibernateInitializer
	{
		private const string ConnectionString =
			@"Data Source=localhost\SQLEXPRESS;Initial Catalog=Blog;Integrated Security=True;Pooling=False";

		private readonly Type[] baseTypesToRecognizeRootEntities = new[] {typeof (Entity<>), typeof (Entity)};
