...
{
	public class MapMapper<TEntity, TKey, TElement> : ICollectionPropertiesMapper<TEntity, TElement> where TEntity : class
	{
		...
		public MapMapper(HbmMap mapping)
		{
			...
			{
				mapping.Item = new HbmMapKey {type = TypeUtils.GetTypeName<TKey>()};
			}
		}
